...
//     setFormData({
//       type: "inbound",
//       source_warehouse: props.selectedOrder.source_warehouse,
//       destination_warehouse: userWarehouseId || props.selectedOrder.destination_warehouse,
...
//     const initialData = {
//       type: "outbound",
//       source_warehouse: isAdmin ? "" : userWarehouseId,
...
//   }
// }, [props.selectedOrder, props.productList]);
...
//                   <FormControl
//                     type="text"
//                     value={formData.type === "inbound" ? "Inbound" : "Outbound"}
//                     disabled
//                   />
//                 </FormGroup>
//               </Col>
...
//                     disabled={
//                       formData.type === "inbound" ||
//                       (!isAdmin && formData.type === "outbound")
//                     }
//                     onChange={(e) =>
//                       setFormData({
//                         ...formData,
...
//                     disabled={formData.type === "inbound" && !isAdmin}
//                     onChange={(e) =>
//                       setFormData({
//                         ...formData,
...
//                     {!props.selectedOrder && <th>Action</th>}
//                   </tr>
//                 </thead>
//                 <tbody>
